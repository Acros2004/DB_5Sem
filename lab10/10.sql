...
UPDATE TEACHER SET BIRTHDAY='10.11.1963', SALARY=50 WHERE TEACHER='СМЛВ';
...
create view Count_Birthday as 
    select TO_CHAR(birthday,'mm') "Месяц",count(*) "кол-во"
    from teacher
...
select TO_CHAR(birthday, 'yyyy') from teacher where teacher.teacher = 'СМЛВ';
